        ...
        <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium">
              Gestionando <span className="text-orange-600">{filteredClients.length}</span> clientes activos
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-200 transition-all active:scale-95 font-bold text-sm">
        ...
        <div className="max-w-[1600px] mx-auto">
          {filteredClients.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
              ...
              <p className="text-slate-500 mb-6">Prueba con otros términos o crea un nuevo registro.</p>
              <button 
                onClick={() => setSearchTerm("")}
